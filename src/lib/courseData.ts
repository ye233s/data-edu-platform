...
export const coursesData: Course[] = [
  ...
  // 课程3: Excel数据分析 - 6章
  {
    ...
    chapters: [
      { id: '1', title: 'Excel基础操作', duration: 60, contents: [
        ...
        { id: '2', type: 'text', title: '数据录入练习', duration: 25, content: '# Excel数据录入练习\n\n请下载练习文件并在本地Excel中完成：\n\n📥 [练习文件1-数据录入.csv](/files/excel-practice-1.csv)\n\n## 练习内容\n\n1. 录入以下销售数据：\n\n| 日期 | 产品 | 销量 | 单价 | 销售额 |\n|------|------|------|------|--------|\n| 1月1日 | A产品 | 100 | 50 | 5000 |\n| 1月2日 | A产品 | 120 | 50 | 6000 |\n| 1月3日 | B产品 | 80 | 80 | 6400 |\n\n2. 使用公式计算：\n   - 总销售额：=SUM(E2:E4)\n   - 平均销量：=AVERAGE(C2:C4)\n   - 最高单价：=MAX(D2:D4)\n   - 最低单价：=MIN(D2:D4)\n\n## 预期结果\n\n- 总销售额: 17,400\n- 平均销量: 100\n- 最高单价: 80\n- 最低单价: 50' }
      ]},
      { id: '2', title: '常用函数', duration: 90, contents: [
        ...
        { id: '2', type: 'text', title: '函数练习', duration: 35, content: '# Excel函数综合练习\n\n📥 [练习文件2-函数练习.csv](/files/excel-practice-2.csv)\n\n## 练习数据\n\n| 姓名 | 分数 | 城市 |\n|------|------|------|\n| 张三 | 85 | 北京 |\n| 李四 | 92 | 上海 |\n| 王五 | 78 | 北京 |\n| 赵六 | 88 | 上海 |\n\n## 练习任务\n\n1. 使用以下函数计算：\n   - 总分：=SUM(B2:B5)\n   - 平均分：=AVERAGE(B2:B5)\n   - 人数：=COUNT(B2:B5)\n   - 最高分：=MAX(B2:B5)\n   - 最低分：=MIN(B2:B5)\n   - 北京人数：=COUNTIF(C2:C5, "北京")\n   - 北京总分：=SUMIF(C2:C5, "北京", B2:B5)\n\n## 预期结果\n\n- 总分: 343\n- 平均分: 85.75\n- 人数: 4\n- 最高分: 92\n- 最低分: 78\n- 北京人数: 2\n- 北京总分: 163' },
      ...
      { id: '3', title: '数据清洗', duration: 75, contents: [
        ...
        { id: '2', type: 'text', title: '数据清洗练习', duration: 30, content: '# Excel数据清洗练习\n\n📥 [练习文件3-数据清洗.csv](/files/excel-practice-3.csv)\n\n## 练习内容\n\n| 原始数据 | 需要结果 | 函数 |\n|---------|---------|------|\n| " 张三 " | 张三 | TRIM |\n| "13800138000" | 138 | LEFT 3位 |\n| "hello world" | HELLO WORLD | UPPER |\n| "Hello" | hello | LOWER |\n| "ABC123" | 6 | LEN |\n\n## 文本函数练习\n\n- =TRIM(" 张三 ") → 张三\n- =LEFT("13800138000", 3) → 138\n- =RIGHT("13800138000", 4) → 8000\n- =LEN("ABC123") → 6\n\n## 其他数据清洗技巧\n\n- 删除重复值：数据 → 删除重复值\n- 文本分列：数据 → 分列\n- 填充空值：Ctrl+G定位空值 → 输入内容 → Ctrl+Enter' }
      ]},
      { id: '4', title: '数据透视表', duration: 90, contents: [
        { id: '1', type: 'text', title: '数据透视表基础', duration: 25, content: '# 数据透视表\n\n## 创建步骤\n\n1. 选择数据区域\n2. 插入 -> 数据透视表\n3. 拖拽字段到行、列、值区域\n\n## 字段设置\n\n- 行：分类字段\n- 列：分组字段\n- 值：汇总字段\n- 筛选：过滤条件' },
        { id: '2', type: 'text', title: '数据透视表练习', duration: 35, content: '# Excel数据透视表练习\n\n📥 [练习文件4-数据透视表.csv](/files/excel-practice-4.csv)\n\n## 练习数据\n\n| 日期 | 地区 | 产品 | 销售额 |\n|------|------|------|--------|\n| 1月 | 北京 | 电脑 | 500000 |\n| 1月 | 北京 | 手机 | 400000 |\n| 1月 | 上海 | 电脑 | 400000 |\n| 1月 | 上海 | 手机 | 300000 |\n| 2月 | 北京 | 电脑 | 600000 |\n| 2月 | 北京 | 手机 | 360000 |\n\n## 创建透视表步骤\n\n1. 选中数据区域\n2. 点击 插入 → 数据透视表\n3. 设置字段：\n   - 行：地区\n   - 列：产品\n   - 值：销售额（求和）\n\n## 预期结果\n\n| 地区 | 电脑 | 手机 | 总计 |\n|------|------|------|------|\n| 北京 | 1,100,000 | 760,000 | 1,860,000 |\n| 上海 | 850,000 | 620,000 | 1,470,000 |' }
      ]},
      { id: '5', title: '图表制作', duration: 70, contents: [
        { id: '1', type: 'text', title: '图表制作基础', duration: 25, content: '# Excel图表制作基础\n\n## 图表的作用\n\n- 直观展示数据分布和趋势\n- 快速发现异常值和规律\n- 让汇报更有说服力\n\n## 常用图表类型\n\n| 图表类型 | 适用场景 | 示例 |\n|---------|---------|------|\n| 柱状图 | 对比不同类别的数值大小 | 各产品销售额对比 |\n| 折线图 | 展示数据随时间的变化趋势 | 月度销售趋势 |\n| 饼图 | 显示各部分占总体的比例 | 各区域销售占比 |\n| 条形图 | 类别名称较长或类别较多时 | 员工绩效排名 |\n| 组合图 | 同时展示两个不同量级的指标 | 销售额+利润率 |\n\n## 创建图表的通用步骤\n\n1. 选择数据区域（包含表头）\n2. 点击 插入 → 选择图表类型\n3. 调整图表标题、坐标轴、图例\n4. 设置数据标签（可选）\n5. 美化样式（颜色、字体等）\n\n## 图表设计原则\n\n- 简洁：避免过多装饰元素\n- 准确：坐标轴从0开始（折线图除外）\n- 一致：同一报告中图表风格统一\n- 有意义：每张图表都要传递一个信息' },
        { id: '2', type: 'text', title: '图表制作练习', duration: 30, content: '# Excel图表制作练习\n\n📥 [练习文件5-图表制作.csv](/files/excel-practice-5.csv)\n\n## 练习数据\n\n| 月份 | 销售额 | 成本 | 利润 |\n|------|--------|------|------|\n| 1月 | 100,000 | 60,000 | 40,000 |\n| 2月 | 120,000 | 70,000 | 50,000 |\n| 3月 | 110,000 | 65,000 | 45,000 |\n| 4月 | 130,000 | 75,000 | 55,000 |\n| 5月 | 140,000 | 80,000 | 60,000 |\n| 6月 | 150,000 | 85,000 | 65,000 |\n\n## 练习任务\n\n### 任务1：柱状图 - 对比各月销售额\n1. 选择A1:B7区域（月份和销售额）\n2. 插入 → 簇状柱形图\n3. 添加图表标题"2024年上半年销售额"\n4. 添加数据标签\n\n### 任务2：折线图 - 展示销售趋势\n1. 选择A1:B7区域\n2. 插入 → 折线图\n3. 添加趋势线（右键数据线 → 添加趋势线）\n4. 观察整体走势：持续上升\n\n### 任务3：饼图 - 显示6月成本和利润占比\n1. 选择B6:D6（6月的销售额、成本、利润）和对应的表头\n2. 插入 → 饼图\n3. 添加数据标签（显示百分比）\n4. 预期占比：销售额51%，成本29%，利润22%\n\n### 任务4：组合图 - 销售额（柱）+ 利润率（线）\n1. 选择A1:D7区域\n2. 插入 → 图表 → 组合图\n3. 设置销售额和成本为柱形，利润为折线（次坐标轴）\n\n## 预期结果\n\n- 柱状图：6月柱最高，1月最低，呈上升趋势\n- 折线图：整体上升，6月达到峰值150,000\n- 饼图：6月利润占比约22%，成本约29%\n- 组合图：可同时看到销售额绝对值和利润增长趋势\n\n## 常用函数辅助图表制作\n\n- =SUM(B2:B7) → 总销售额 750,000\n- =AVERAGE(B2:B7) → 月均销售额 125,000\n- =MAX(B2:B7) → 最高月 150,000 (6月)\n- =MIN(B2:B7) → 最低月 100,000 (1月)\n- =(B7-B2)/B2 → 增长率 50%' }
      ]},
      { id: '6', title: '条件格式与高级应用', duration: 70, contents: [
        { id: '1', type: 'text', title: '条件格式基础', duration: 25, content: '# Excel条件格式\n\n## 条件格式的作用\n\n- 快速定位异常数据\n- 可视化数值大小对比\n- 自动标记满足条件的单元格\n\n## 条件格式类型\n\n| 类型 | 效果 | 适用场景 |\n|------|------|---------|\n| 数据条 | 单元格内显示横向条形图，长度对应数值大小 | 对比一列数值 |\n| 色阶 | 用颜色渐变表示数值高低（绿-黄-红） | 温度图、绩效 |\n| 图标集 | 在数值前显示箭头/圆形/旗帜等图标 | 状态标记 |\n| 突出显示单元格规则 | 大于/小于/等于/包含某值时突出显示 | 异常值标记 |\n| 项目选取规则 | 前N项、后N项、高于/低于平均值 | 找出TOP10 |\n\n## 操作步骤\n\n1. 选择要应用条件格式的区域\n2. 开始 → 条件格式\n3. 选择规则类型\n4. 设置条件和格式样式\n5. 确定\n\n## 自定义公式规则（高级）\n\n使用公式来定义更灵活的规则，例如：\n- `=A2>100` —— 当A列值大于100时\n- `=AND(A2>60, A2<80)` —— 介于60-80之间\n- `=COUNTIF(A:A, A2)>1` —— 标记重复值' },
        { id: '2', type: 'text', title: '条件格式练习', duration: 30, content: '# Excel条件格式综合练习\n\n📥 [练习文件6-条件格式.csv](/files/excel-practice-6.csv)\n\n## 练习数据\n\n| 姓名 | 分数 | 城市 | 出勤率 |\n|------|------|------|--------|\n| 张三 | 85 | 北京 | 98% |\n| 李四 | 92 | 上海 | 95% |\n| 王五 | 78 | 北京 | 88% |\n| 赵六 | 55 | 上海 | 75% |\n| 钱七 | 88 | 北京 | 92% |\n| 孙八 | 65 | 上海 | 80% |\n\n## 练习任务\n\n### 任务1：突出显示不及格分数\n1. 选择B2:B7（分数列）\n2. 条件格式 → 突出显示单元格规则 → 小于\n3. 设置值为 60，格式为"浅红填充色 深红色文本"\n\n### 任务2：使用图标集标记分数等级\n1. 选择B2:B7\n2. 条件格式 → 图标集 → 三等级（红黄绿圆圈）\n3. 绿色圆圈：分数≥80\n   黄色圆圈：60≤分数<80\n   红色圆圈：分数<60\n\n### 任务3：数据条显示出勤率\n1. 选择D2:D7（出勤率列）\n2. 条件格式 → 数据条 → 渐变填充（蓝色）\n3. 出勤率越高，数据条越长\n\n### 任务4：色阶显示整体表现\n1. 选择B2:D7\n2. 条件格式 → 色阶 → 三色刻度（绿-黄-红）\n3. 绿色代表高值，红色代表低值\n\n### 任务5：自定义公式标记北京地区\n1. 选择A2:D7（整个数据区域）\n2. 条件格式 → 新建规则 → 使用公式确定要设置格式的单元格\n3. 输入公式：`=$C2="北京"` （注意$符号锁定C列）\n4. 设置格式：黄色填充\n5. 效果：所有北京地区的行被高亮\n\n### 任务6：项目选取规则 - TOP3高分\n1. 选择B2:B7\n2. 条件格式 → 项目选取规则 → 值最大的10项\n3. 修改为3项，设置格式为"绿填充色 深绿色文本"\n\n## 预期结果\n\n- 不及格（55分）被红色突出显示\n- 分数列显示三色图标：李四(92)、钱七(88)、张三(85)为绿色圆圈，王五(78)、孙八(65)为黄色圆圈，赵六(55)为红色圆圈\n- 出勤率列数据条长度依次递减（张三98%最长，赵六75%最短）\n- TOP3高分（李四92、钱七88、张三85）被绿色突出显示\n- 北京地区行（张三、王五、钱七）被黄色高亮\n\n## 辅助函数验证\n\n- =AVERAGE(B2:B7) → 平均分 77.17\n- =MAX(B2:B7) → 最高分 92 (李四)\n- =MIN(B2:B7) → 最低分 55 (赵六)\n- =COUNTIF(B2:B7, ">=60") → 及格人数 5\n- =COUNTIF(C2:C7, "北京") → 北京人数 3\n- =SUMIF(C2:C7, "北京", B2:B7) → 北京总分 251' }
      ]}
    ]
  },
...

  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=800&h=450&fit=crop',
    difficulty: '高级',
    duration: 18,
    instructor: '林老师',
