  ...
  // 课程3: Excel数据分析 - 6章
  {
    ...
    chapters: [
      { id: '1', title: 'Excel基础操作', duration: 60, contents: [
        ...
        { id: '2', type: 'code', title: '数据录入练习', duration: 25, code: '-- Excel数据录入练习\n| 日期 | 产品 | 销量 | 单价 | 销售额 |\n|------|------|------|------|--------|\n| 1月1日 | A产品 | 100 | 50 | 5000 |\n| 1月2日 | A产品 | 120 | 50 | 6000 |\n| 1月3日 | B产品 | 80 | 80 | 6400 |\n\n-- 常用函数练习\n=SUM(E2:E4)    -- 结果: 17400\n=AVERAGE(C2:C4)  -- 结果: 100\n=MAX(D2:D4)    -- 结果: 80\n=MIN(D2:D4)    -- 结果: 50', expectedOutput: '-- Excel公式练习 --\nSUM: 17,400\nAVERAGE: 100\nMAX: 80\nMIN: 50' }
      ]},
      { id: '2', title: '常用函数', duration: 90, contents: [
        ...
        { id: '2', type: 'code', title: '函数练习', duration: 35, code: '-- Excel函数综合练习\n| 姓名 | 分数 | 城市 |\n|------|------|------|\n| 张三 | 85 | 北京 |\n| 李四 | 92 | 上海 |\n| 王五 | 78 | 北京 |\n| 赵六 | 88 | 上海 |\n\n-- 统计练习\n=SUM(B2:B5)    -- 总分: 343\n=AVERAGE(B2:B5)  -- 平均分: 85.75\n=COUNT(B2:B5)  -- 人数: 4\n=MAX(B2:B5)    -- 最高分: 92\n=MIN(B2:B5)    -- 最低分: 78\n=COUNTIF(C2:C5, "北京")  -- 北京人数: 2\n=SUMIF(C2:C5, "北京", B2:B5)  -- 北京总分: 163', expectedOutput: '-- 函数计算结果 --\n总分: 343\n平均分: 85.75\n人数: 4\n最高分: 92\n最低分: 78\n北京人数: 2\n北京总分: 163' },
      ...
      { id: '3', title: '数据清洗', duration: 75, contents: [
        ...
        { id: '2', type: 'code', title: '数据清洗练习', duration: 30, code: '-- Excel数据清洗练习\n| 原始数据 | 处理结果 |\n|---------|---------|\n| " 张三 " | TRIM: 张三 |\n| "13800138000" | LEFT 3位: 138 |\n| "hello world" | UPPER: HELLO WORLD |\n| "Hello" | LOWER: hello |\n| "ABC123" | LEN: 6 |\n\n-- 文本函数应用\n=TRIM(" 张三 ")     -- 张三\n=LEFT("13800138000", 3)  -- 138\n=RIGHT("13800138000", 4) -- 8000\n=LEN("ABC123")      -- 6', expectedOutput: '-- 数据清洗结果 --\n去除空格: 张三\n提取区号: 138\n提取尾号: 8000\n字符长度: 6' }
      ]},
      { id: '4', title: '数据透视表', duration: 90, contents: [
        { id: '1', type: 'text', title: '数据透视表基础', duration: 25, content: '# 数据透视表\n\n## 创建步骤\n\n1. 选择数据区域\n2. 插入 -> 数据透视表\n3. 拖拽字段到行、列、值区域\n\n## 字段设置\n\n- 行：分类字段\n- 列：分组字段\n- 值：汇总字段\n- 筛选：过滤条件' },
        { id: '2', type: 'code', title: '数据透视表练习', duration: 35, code: '-- Excel数据透视表练习\n| 日期 | 地区 | 产品 | 销售额 |\n|------|------|------|--------|\n| 1月 | 北京 | 电脑 | 500000 |\n| 1月 | 北京 | 手机 | 400000 |\n| 1月 | 上海 | 电脑 | 400000 |\n| 1月 | 上海 | 手机 | 300000 |\n| 2月 | 北京 | 电脑 | 600000 |\n| 2月 | 北京 | 手机 | 360000 |\n\n-- 透视表结果\n行: 地区\n列: 产品\n值: 销售额（求和）\n\n| 地区 | 电脑 | 手机 | 总计 |\n|------|------|------|------|\n| 北京 | 1,100,000 | 760,000 | 1,860,000 |\n| 上海 | 850,000 | 620,000 | 1,470,000 |', expectedOutput: '-- 数据透视表结果 --\n\n按地区-产品交叉统计:\n\n        电脑        手机       总计\n北京  1,100,000   760,000  1,860,000\n上海    850,000   620,000  1,470,000\n\n总计: 3,330,000' }
      ]},
      { id: '5', title: '图表制作', duration: 70, contents: [
        { id: '1', type: 'code', title: '图表制作练习', duration: 30, code: '-- Excel图表制作\n| 月份 | 销售额 | 成本 |\n|------|--------|------|\n| 1月 | 100000 | 60000 |\n| 2月 | 120000 | 70000 |\n| 3月 | 110000 | 65000 |\n| 4月 | 130000 | 75000 |\n| 5月 | 140000 | 80000 |\n\n-- 创建图表步骤:\n1. 选择数据区域\n2. 插入 -> 推荐的图表\n3. 选择图表类型\n\n-- 推荐图表:\n- 柱状图: 对比不同类别\n- 折线图: 展示趋势变化\n- 饼图: 显示占比关系\n- 组合图: 同时展示多个指标', expectedOutput: '-- 图表制作要点 --\n\n1. 柱状图: 适合对比各月销售额\n2. 折线图: 展示销售额趋势\n3. 饼图: 显示各月占比\n4. 组合图: 销售额+成本对比' }
      ]},
      { id: '6', title: '条件格式与高级应用', duration: 70, contents: [
        { id: '1', type: 'code', title: '条件格式练习', duration: 30, code: '-- Excel条件格式练习\n| 姓名 | 分数 | 标记 |\n|------|------|------|\n| 张三 | 85 | <60红色, 60-80黄色, >80绿色 |\n| 李四 | 92 | |\n| 王五 | 78 | |\n| 赵六 | 55 | |\n\n-- 条件格式规则:\n1. 选中分数列\n2. 开始 -> 条件格式\n3. 新建规则\n4. 设置格式条件\n\n-- 数据条: 可视化数值大小\n-- 色阶: 数值分布\n-- 图标集: 状态指示', expectedOutput: '-- 条件格式应用 --\n\n分数85 (绿色): 优秀\n分数92 (绿色): 优秀\n分数78 (黄色): 良好\n分数55 (红色): 不及格\n\n可视化效果:\n绿色条纹 + 红色警告图标' }
      ]}
    ]
  },
